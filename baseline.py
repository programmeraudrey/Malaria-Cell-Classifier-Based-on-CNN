...
if __name__ == "__main__":
    ...
    print(filename_time)  # 输出示例: 20240730_153045
    ckpt_path = f'./checkpoints/best_malaria_cnn_{arg}_{filename_time}.pth'

    # 重定向标准输出到日志文件
    log_path = f'./logs/baseline_training_log_{arg}_{filename_time}.txt'
    ...
    plt.tight_layout()
    plt.savefig(f"./pngs/training_curv_{arg}_{filename_time}.png")